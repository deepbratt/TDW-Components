...
var FilterAccordion = function (_a) {
    ...
    //     };
    return (React__default.createElement(Accordion$1, { className: root },
        React__default.createElement(AccordionSummary$1, { expandIcon: React__default.createElement(ExpandMoreIcon, null), "aria-controls": "panel1bh-content", id: "panel1bh-header" },
            React__default.createElement(Typography$1, null, title)),
        React__default.createElement(AccordionDetails$1, null, children)));
};
...
var InputField = function (_a) {
    ...
    return (React__default.createElement(TextField$1, __assign({ className: root, placeholder: placeholder, name: name, value: value, variant: variant, multiline: multiline, fullWidth: fullWidth, rows: rows, size: size, rowsMax: rowsMax, onChange: onChange }, (error && { error: true, helperText: error }), { InputProps: {
            classes: { input: input },
        } })));
};
...
var InputFieldWithButton = function (_a) {
    ...
    return (React__default.createElement(TextField$1, __assign({ className: root, placeholder: placeholder, name: name, value: value, variant: variant, multiline: multiline, fullWidth: fullWidth, rows: rows, size: size, rowsMax: rowsMax, onChange: onChange }, (error && { error: true, helperText: error }), { InputProps: {
            ...
            endAdornment: (React__default.createElement(InputAdornment$1, { position: "end" },
                React__default.createElement(Button$1, { className: btn, color: "primary", variant: "contained", onClick: function () { return handleClick(); } }, buttonlabel))),
        } })));
};
