...
function createSvgIcon$1(path, displayName) {
  var Component = function Component(props, ref) {
    return /*#__PURE__*/React__default['default'].createElement(SvgIcon$1, _extends({
      ref: ref
    }, props), path);
  };
...
var Collapse = /*#__PURE__*/React__namespace.forwardRef(function Collapse(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(TransitionComponent, _extends({
    in: inProp,
    onEnter: handleEnter,
...
var Collapse$1 = withStyles(styles$t, {
  name: 'MuiCollapse'
})(Collapse);
...
var Accordion = /*#__PURE__*/React__namespace.forwardRef(function Accordion(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(Paper$1, _extends({
    className: clsx(classes.root, className, expanded && classes.expanded, disabled && classes.disabled, !square && classes.rounded),
    ref: ref,
    square: square
  }, other), /*#__PURE__*/React__namespace.createElement(AccordionContext.Provider, {
    value: contextValue
  }, summary), /*#__PURE__*/React__namespace.createElement(TransitionComponent, _extends({
    in: expanded,
    timeout: "auto"
...
var Accordion$1 = withStyles(styles$r, {
  name: 'MuiAccordion'
})(Accordion);
...
var AccordionDetails$1 = withStyles(styles$q, {
...
var AccordionSummary = /*#__PURE__*/React__namespace.forwardRef(function AccordionSummary(props, ref) {
  ...
  var _React$useContext = React__namespace.useContext(AccordionContext),
  ...
  }, children), expandIcon && /*#__PURE__*/React__namespace.createElement(IconButton$1, _extends({
...
var AccordionSummary$1 = withStyles(styles$m, {
...
var SimpleBackdrop = /*#__PURE__*/React__namespace.forwardRef(function SimpleBackdrop(props, ref) {
  ...
  return open ? /*#__PURE__*/React__namespace.createElement("div", _extends({
    "aria-hidden": true,
    ref: ref
  }, other, {
    style: _extends({}, styles$j.root, invisible ? styles$j.invisible : {}, other.style)
  })) : null;
});
...
var Modal = /*#__PURE__*/React__namespace.forwardRef(function Modal(inProps, ref) {
  ...
  }), hideBackdrop ? null : /*#__PURE__*/React__namespace.createElement(BackdropComponent, _extends({
    open: open,
...
var FilledInput = /*#__PURE__*/React__namespace.forwardRef(function FilledInput(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(InputBase$1, _extends({
...
var FormControl = /*#__PURE__*/React__namespace.forwardRef(function FormControl(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(FormControlContext.Provider, {
    value: childContext
  }, /*#__PURE__*/React__namespace.createElement(Component, _extends({
...
var FormControl$1 = withStyles(styles$e, {
  name: 'MuiFormControl'
})(FormControl);
...
Input.muiName = 'Input';
var Input$1 = withStyles(styles$a, {
  name: 'MuiInput'
})(Input);
...
var InputAdornment$1 = withStyles(styles$9, {
...
var InputLabel = /*#__PURE__*/React__namespace.forwardRef(function InputLabel(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(FormLabel$1, _extends({
    "data-shrink": shrink,
...
var InputLabel$1 = withStyles(styles$8, {
  name: 'MuiInputLabel'
})(InputLabel);
...
var Popover = /*#__PURE__*/React__namespace.forwardRef(function Popover(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(Modal, _extends({
    container: container,
    open: open,
    ref: ref,
    BackdropProps: {
    ...
    className: clsx(classes.root, className)
  }, other), /*#__PURE__*/React__namespace.createElement(TransitionComponent, _extends({
    appear: true,
    in: open,
    onEnter: onEnter,
    onEntered: onEntered,
  ...
  }), /*#__PURE__*/React__namespace.createElement(Paper$1, _extends({
    elevation: elevation,
    ref: handlePaperRef
  }, PaperProps, {
...
var Popover$1 = withStyles(styles$6, {
  name: 'MuiPopover'
})(Popover);
...
var MenuList = /*#__PURE__*/React__namespace.forwardRef(function MenuList(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(List$1, _extends({
    role: "menu",
    ref: handleRef,
    className: className,
    onKeyDown: handleKeyDown,
...
var Menu = /*#__PURE__*/React__namespace.forwardRef(function Menu(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(Popover$1, _extends({
  ...
  }, other), /*#__PURE__*/React__namespace.createElement(MenuList, _extends({
...
var NativeSelectInput = /*#__PURE__*/React__namespace.forwardRef(function NativeSelectInput(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement("select", _extends({
...
var NotchedOutline$1 = withStyles(styles$3, {
...
var OutlinedInput$1 = withStyles(styles$2, {
...
var SelectInput = /*#__PURE__*/React__namespace.forwardRef(function SelectInput(props, ref) {
  ...
  }) : display), /*#__PURE__*/React__namespace.createElement("input", _extends({
  ...
  }), /*#__PURE__*/React__namespace.createElement(Menu$1, _extends({
    id: "menu-".concat(name || ''),
...
var Select$1 = withStyles(styles$1, {
  name: 'MuiSelect'
})(Select);
...
var TextField = /*#__PURE__*/React__namespace.forwardRef(function TextField(props, ref) {
  ...
  var InputElement = /*#__PURE__*/React__namespace.createElement(InputComponent, _extends({
  ...
  return /*#__PURE__*/React__namespace.createElement(FormControl$1, _extends({
    className: clsx(classes.root, className),
    disabled: disabled,
    error: error,
    fullWidth: fullWidth,
    ...
    color: color,
    variant: variant
  }, other), label && /*#__PURE__*/React__namespace.createElement(InputLabel$1, _extends({
    htmlFor: id,
    id: inputLabelId
  }, InputLabelProps), label), select ? /*#__PURE__*/React__namespace.createElement(Select$1, _extends({
    "aria-describedby": helperTextId,
    id: id,
    labelId: inputLabelId,
    value: value,
    input: InputElement
  }, SelectProps), children) : InputElement, helperText && /*#__PURE__*/React__namespace.createElement(FormHelperText$1, _extends({
    id: helperTextId
...
var AccordionStyles = makeStyles(function () { return ({
    root: {
        boxShadow: "none",
    },
}); });
...
var FilterAccordion = function (_a) {
    ...
    var root = AccordionStyles().root;
    //   const [expanded, setExpanded] = useState<string | false>(false);
    //   const handleChange =
    //     (panel: string) => (event: React.SyntheticEvent, isExpanded: boolean) => {
    //       setExpanded(isExpanded ? panel : false);
    //     };
    return (React__default['default'].createElement(Accordion$1, { className: root },
        React__default['default'].createElement(AccordionSummary$1, { expandIcon: React__default['default'].createElement(ExpandMoreIcon, null), "aria-controls": "panel1bh-content", id: "panel1bh-header" },
            React__default['default'].createElement(Typography$1, null, title)),
        React__default['default'].createElement(AccordionDetails$1, null, children)));
};
...
var LayoutStyle = makeStyles(function (theme) {
    var _a, _b;
    return ({
        root: {
            marginTop: "10px",
...
var InputField = function (_a) {
    var value = _a.value, multiline = _a.multiline, fullWidth = _a.fullWidth, placeholder = _a.placeholder, name = _a.name, variant = _a.variant, size = _a.size, rows = _a.rows, rowsMax = _a.rowsMax, _b = _a.error, error = _b === void 0 ? null : _b, onChange = _a.onChange;
    var _c = LayoutStyle(), root = _c.root, input = _c.input;
    return (React__default['default'].createElement(TextField$1, __assign({ className: root, placeholder: placeholder, name: name, value: value, variant: variant, multiline: multiline, fullWidth: fullWidth, rows: rows, size: size, rowsMax: rowsMax, onChange: onChange }, (error && { error: true, helperText: error }), { InputProps: {
            classes: { input: input },
        } })));
};
...
var InputFieldWithButton = function (_a) {
    var value = _a.value, multiline = _a.multiline, fullWidth = _a.fullWidth, placeholder = _a.placeholder, name = _a.name, variant = _a.variant, size = _a.size, rows = _a.rows, rowsMax = _a.rowsMax, _b = _a.error, error = _b === void 0 ? null : _b, onChange = _a.onChange, buttonlabel = _a.buttonlabel, handleClick = _a.handleClick;
    var _c = LayoutStyle(), root = _c.root, input = _c.input, btn = _c.btn;
    return (React__default['default'].createElement(TextField$1, __assign({ className: root, placeholder: placeholder, name: name, value: value, variant: variant, multiline: multiline, fullWidth: fullWidth, rows: rows, size: size, rowsMax: rowsMax, onChange: onChange }, (error && { error: true, helperText: error }), { InputProps: {
            classes: { input: input },
            endAdornment: (React__default['default'].createElement(InputAdornment$1, { position: "end" },
                React__default['default'].createElement(Button$1, { className: btn, color: "primary", variant: "contained", onClick: function () { return handleClick(); } }, buttonlabel))),
        } })));
};
...
exports.InputFieldWithButton = InputFieldWithButton;
