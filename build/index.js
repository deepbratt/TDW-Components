...
var MuiButton = withStyles(styles$1, {
  name: 'MuiButton'
})(Button);
...
var Sizes$1 = function () {
    var theme = useTheme();
    var desktop = useMediaQuery(theme.breakpoints.up("lg"));
    var tablet = useMediaQuery(theme.breakpoints.only("md"));
    var mobile = useMediaQuery(theme.breakpoints.only("xs"));
    return { desktop: desktop, tablet: tablet, mobile: mobile };
};

var Breakpoints = function () {
    var _a = Sizes$1(), desktop = _a.desktop, tablet = _a.tablet, mobile = _a.mobile;
    if (desktop)
        return "large";
    if (tablet)
        return "medium";
...
function CustomButton(_a) {
    var fullWidth = _a.fullWidth, variant = _a.variant, radius = _a.radius, styles = _a.styles, color = _a.color, handleClick = _a.handleClick, size = _a.size, children = _a.children, rest = __rest(_a, ["fullWidth", "variant", "radius", "styles", "color", "handleClick", "size", "children"]);
    return (React__namespace.createElement(MuiButton, __assign({ onClick: handleClick, size: size ? size : Breakpoints(), className: styles, style: { borderRadius: radius }, variant: variant, color: color, fullWidth: fullWidth }, rest), children));
}
CustomButton.defaultProps = {
    ...
    variant: "contained",
    radius: "4px",
    handleClick: function () { return console.log("buttonClicked"); },
};
...
var Size = function () {
    var _a = Sizes(), desktop = _a.desktop, tablet = _a.tablet, mobile = _a.mobile;
    if (desktop)
        return "1.9rem";
    if (tablet)
        return "1.875rem";
...
var CustomTitle = function (_a) {
    var color = _a.color, text = _a.text, subTitleColor = _a.subTitleColor, subTitle = _a.subTitle, underlined = _a.underlined, rest = __rest(_a, ["color", "text", "subTitleColor", "subTitle", "underlined"]);
    var _b = LayoutStyle(), underlinedStyles = _b.underlinedStyles, sectionHeader = _b.sectionHeader, subHeader = _b.subHeader;
    var borderBottom = underlined;
    return (React__namespace.createElement("div", { className: sectionHeader },
        React__namespace.createElement(Typography$1, __assign({ color: "primary", style: { color: color, fontSize: Size(), lineHeight: 1.8 }, variant: "h2" }, rest),
            React__namespace.createElement("span", { className: borderBottom ? underlinedStyles : "" }, text)),
        subTitle && (React__namespace.createElement(Typography$1, __assign({ className: subHeader }, rest, { color: "primary", variant: "subtitle1", style: { color: subTitleColor } }), subTitle))));
};
...
var Section = function (_a) {
    var children = _a.children, backColor = _a.backColor;
    var _b = LayoutStyle(), root = _b.root, content = _b.content;
    return (React__namespace.createElement("div", { className: root, style: { backgroundColor: backColor } },
        React__namespace.createElement("div", { className: content },
            React__namespace.createElement(StyledGrid, { item: true, xs: 12 }, children))));
};
